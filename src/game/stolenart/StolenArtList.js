...
const StolenArtList = ({caughtFishList, wallet, increaseWallet, removeFromCaughtFishList}) => {
    ...
    // const list = caughtFishList.sort((a,b) => (a.price > b.price) ? 1 : ((b.price > a.price) ? -1 : 0)).map(fishObject => <StolenArt key={fishObject.id} fishObject={fishObject} wallet={wallet} increaseWallet={increaseWallet} removeFromCaughtFishList={removeFromCaughtFishList}/>);
    ...
    return ( 
        <div className="caught-fish">
            ...
            <h3>Total value of collection:</h3>
